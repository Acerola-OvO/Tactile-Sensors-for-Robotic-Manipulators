// Repository note:
// This firmware was used as the reference scan program in Xu Cheng's
// tactile-sensor graduation project. It is derived from the 3D-ViTac project.
// The original copyright and MIT license notice are retained below.
//
// IMPORTANT: the inherited shift-register sequence should be verified against
// physical column indexing before quantitative use. See firmware/README.md.
